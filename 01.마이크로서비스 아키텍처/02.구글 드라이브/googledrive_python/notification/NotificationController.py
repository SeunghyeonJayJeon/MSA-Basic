...
def Post():
    response = NotificationRepository.Create(request)
...
def Get():
    response = NotificationRepository.Read(request)
...
def Get_By_Id(id: int):
    response = NotificationRepository.Read_by_id(id)
...
def Update(id: int):
    ...
    response = NotificationRepository.Update(id, request)
