...
from PolicyHandler import wheneverFileUploaded_NotifyToUser
from PolicyHandler import wheneverVideoProcessed_NotifyToUser
...
def consume(msg):
    ...
    if data['eventType'] == "FileUploaded""VideoProcessed":
        wheneverFileUploaded_NotifyToUser(data)
        wheneverVideoProcessed_NotifyToUser(data)
